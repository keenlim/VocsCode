 ...
 * edits, and the rule that it edits an existing file and never creates one.
 *
 ...
 * `Explore.md` left the agent describing itself as "a general-purpose Claude Code agent". So writing
 * a definition is a decision only its author gets to make, and this module must not make it.
 */
...
import { CLAUDE_AGENT_DIR, claudeAgentDir, hasClaudeAgentPins, isPinnedModel, listClaudeAgents, setClaudeAgentModel } from '../src/main/claude-agents';
